...
# @bot.message_handler(content_types=['photo', 'text', 'audio', 'document', 'photo', 'sticker', 'video', 'video_note', 'voice', 'location', 'contact', 'new_chat_members', 'left_chat_member', 'new_chat_title', 'new_chat_photo', 'delete_chat_photo', 'group_chat_created', 'supergroup_chat_created', 'channel_chat_created', 'migrate_to_chat_id', 'migrate_from_chat_id', 'pinned_message'])
# def text_handler(message):
#     chat_id = message.chat.id
#     bot.send_message(chat_id, 'Что-то непонятное пришло!')
